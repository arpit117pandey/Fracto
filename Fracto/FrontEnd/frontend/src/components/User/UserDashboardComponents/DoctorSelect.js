...
function DoctorSelect() {
  ...
  const cities = ["Ballia","Lucknow", "Noida", "Mumbai", "Bangalore", "Chennai"];
  const specialities = ["Surgeon","Dentist", "Gynecologist", "General Physician", "Dermatologist", "ENT Specialist"];
